...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Data Users</h1>
            <p class="text-sm text-gray-500 mt-1">Kelola data pengguna, role, dan departemen.</p>
        </div>

        <a href="{{ route('users.trash') }}" class="group flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg shadow-sm hover:border-red-300 hover:bg-red-50 transition-all duration-200">
            <div class="relative">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                        <div class="relative w-full sm:w-64">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" 
                                ...
                                placeholder="Cari nama atau email..." onchange="this.form.submit()">
                        </div>
                    ...
                    <tr class="bg-white hover:bg-gray-50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xs text-gray-400">Dibuat {{ $user->created_at->format('d M Y') }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('users.edit', $user->uuid) }}" class="group p-2 rounded-lg border border-transparent hover:bg-yellow-50 hover:border-yellow-200 transition-all duration-200" title="Edit">
                                ...
                                <form action="{{ route('users.destroy', $user->uuid) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user {{ $user->name }}?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-sm mt-1">Coba ubah kata kunci pencarian Anda atau tambahkan user baru.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
