...
<head>
    ...
    <title>Ganti Kata Sandi - PGA System</title>
    ...
    <div class="login-card w-full max-w-md glass-effect border-t-4 border-red-600 rounded-2xl shadow-2xl overflow-hidden p-8 opacity-0 translate-y-10">
        ...
        <div class="text-center mb-6 form-element">
            <h1 class="text-3xl font-extrabold text-gray-900 mb-2 tracking-tight">
                Kata Sandi <span class="text-red-600">Baru</span>
            </h1>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="mb-4 form-element">
                ...
                <input id="email" 
                    class="block mt-1 w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:border-red-500 focus:ring-red-500 bg-gray-50 text-gray-800 outline-none" 
                    type="email" 
                    name="email" 
            ...
            <div class="mt-4 mb-6 form-element">
            ...
            <div class="flex items-center justify-end mt-4 form-element">
                <button type="submit" id="resetBtn" class="w-full inline-flex justify-center items-center px-6 py-3 bg-red-600 border border-transparent rounded-full font-bold text-sm text-white uppercase tracking-widest hover:bg-red-700 focus:bg-red-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                    Ubah Kata Sandi
                </button>
            </div>
        </form>
